...
public class Controller : MonoBehaviour {
    ...
    private GameManager_B gameManager_B;
    ...
    void Start()
    {
        gameManager_B = GameObject.Find("GameManager").GetComponent<GameManager_B>();
        ...
        {   
            ...
            {   // enemy를 눌렀을 때
                ...
                {   // 클릭한 enemy가 false면 true 반환, true면 false 반환
                    gameManager_B.NextLevel();    // true를 얻어옴(정답) = 다음 레벨
                }
                else
                {
                    gameManager_B.GameOver();     // false를 얻어옴(틀림) = 게임 오버
                }
            }
            //오류
            else
